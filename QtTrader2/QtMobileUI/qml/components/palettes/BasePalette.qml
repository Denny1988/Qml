...
QtObject {
    ...
    property color primaryText: "#222222"
    property color accentText: "#111111"
    ...
    property color headerTitleBarBackground : "#f0f0f0"
    property color headerTitleBarText : "#111111"
}
