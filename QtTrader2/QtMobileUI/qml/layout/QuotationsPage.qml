...
Item {
    ...
    height: 800
        ...
        QtObject {
           id: fontSettings
           property int normal: 14 * CDimens.fontPointRatio;
           property int insName: 18 * CDimens.fontPointRatio;
           property int insUnit: 16 * CDimens.fontPointRatio;
           property int askBid: 18 * CDimens.fontPointRatio;
           property int unDown: 18 * CDimens.fontPointRatio;
           property int buySell: 18 * CDimens.fontPointRatio;
        }
    ...
    Component {
        ...
        Rectangle {
            ...
            width: parent.width
            height: 21 * CDimens.pixelDensity;
            clip: true;
            Rectangle {
                id: background
                anchors.fill: parent
                ...
                Row {
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            anchors.top: parent.top;
                            anchors.left: parent.left;
                            font.pointSize: fontSettings.insName
                            font.bold: true
                        ...
                        Text {
                            ...
                            anchors.left: parent.left;
                            font.pointSize: fontSettings.insUnit
                            verticalAlignment:Text.AlignVCenter;
                            horizontalAlignment:Text.AlignHCenter;
                            color:"#F07040"
                            text: instrumentUnit
                    ...
                    Rectangle {
                        ...
                        Text {
                            ...
                            anchors.top: parent.top;
                            anchors.left: parent.left;
                            font.pointSize: fontSettings.buySell
                            font.bold: true
                            verticalAlignment:Text.AlignVCenter;
                            horizontalAlignment:Text.AlignHCenter;
                        ...
                        Text {
                            ...
                            font.pointSize: fontSettings.unDown
                            font.bold: true
                            clip:true;
                            verticalAlignment:Text.AlignVCenter;
                            horizontalAlignment:Text.AlignHCenter;
                        ...
                        Text {
                            ...
                            anchors.bottom: parent.bottom;
                            anchors.left: parent.left;
                            font.pointSize: fontSettings.askBid
                            font.bold: true
                            verticalAlignment:Text.AlignVCenter;
                            horizontalAlignment:Text.AlignHCenter;
                            color: priceChangeFlag == 0 ?  "black" : "white"
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Text {
                        ...
                        height: parent.height;
                        text: quotationTime
                        font.pointSize: fontSettings.normal
                        font.bold: true
                        verticalAlignment:Text.AlignVCenter;
                    }
