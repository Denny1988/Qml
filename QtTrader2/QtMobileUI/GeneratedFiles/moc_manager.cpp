...
QT_MOC_LITERAL(3, 21, 16), // "startGetInitData"
QT_MOC_LITERAL(4, 38, 24) // "loginResultCompletedSlot"

    },
    "Manager\0closeSignal\0\0startGetInitData\0"
    "loginResultCompletedSlot"
};
...
void Manager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->startGetInitData(); break;
        case 2: _t->loginResultCompletedSlot(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Manager::closeSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Manager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Manager::startGetInitData)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Manager::closeSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Manager::startGetInitData()
{
