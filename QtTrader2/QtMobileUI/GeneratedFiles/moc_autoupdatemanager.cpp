/****************************************************************************
** Meta object code from reading C++ file 'autoupdatemanager.h'
**
...
#error "The header file 'autoupdatemanager.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 18, 17), // "startUpdateSignal"
QT_MOC_LITERAL(2, 36, 0) // ""

    },
    "AutoUpdateManager\0startUpdateSignal\0"
    ""
};
...
void AutoUpdateManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        AutoUpdateManager *_t = static_cast<AutoUpdateManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (AutoUpdateManager::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AutoUpdateManager::startUpdateSignal)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject AutoUpdateManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_AutoUpdateManager.data,
      qt_meta_data_AutoUpdateManager,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void AutoUpdateManager::startUpdateSignal()
{
