...
public:
    ...
    QString Tr(const QString&,const QString& section);//获取语句相应的翻译; overload;
    QString Tr(const char*,const QString& section);	  //获取语句相应的翻译; overload;
    QString Tr(const char*,const char* section);	  //获取语句相应的翻译; overload;
    QString Tr(const QString&,const char* section);	  //获取语句相应的翻译; overload;
