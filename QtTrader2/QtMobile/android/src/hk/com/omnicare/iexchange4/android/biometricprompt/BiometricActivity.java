...
public class BiometricActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aCache = ACache.get(App.getAppContext());
            ...
            mManager.authenticate(true, new BiometricPromptManager.OnBiometricIdentifyCallback() {
                ...
                public void onSucceeded(FingerprintManager.AuthenticationResult result) {
                    try {
                        ...
                        Toast.makeText(App.getMainActivity(), "登陆成功!", Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
            ...
            mManager.authenticate(false, new BiometricPromptManager.OnBiometricIdentifyCallback() {
                ...
                public void onSucceeded(FingerprintManager.AuthenticationResult result) {
                    try {
                        ...
                        Toast.makeText(App.getMainActivity(),
                        "VERSION_CODES.M_开通成功! 加密IV:" + Base64.encodeToString(iv,Base64.URL_SAFE)
                        + " 加密密码:" + Base64.encodeToString(bytes,Base64.URL_SAFE),
                ...
                public void onSucceeded(BiometricPrompt.AuthenticationResult result) {
                    try {
                        ...
                        fingerLoginEnable = true;
                        Toast.makeText(App.getMainActivity(),
                        "VERSION_CODES.P_开通成功! 加密IV:" + Base64.encodeToString(iv,Base64.URL_SAFE)
                        + " 加密密码:" + Base64.encodeToString(bytes,Base64.URL_SAFE),
                        Toast.LENGTH_LONG).show();
                    }catch (Exception e){
                        e.printStackTrace();
