...
#langauge
#TRANSLATIONS += \
#  Resources/Language/language_eng.ts \
#  Resources/Language/language_chs.ts \
#  Resources/Language/language_cht.ts
...
unix:!mac {
# install
target.path = $$PWD/Unix/android-build/build/outputs/apk
INSTALLS += target
}
